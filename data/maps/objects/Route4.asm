	...
	const_export ROUTE4_TM_WIND_SHEAR
...
Route4_Object:
	...
	def_object_events
	object_event 15, 11, SPRITE_COOLTRAINER_F, WALK, ANY_DIR, TEXT_ROUTE4_COOLTRAINER_F1
	object_event 63,  5, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROUTE4_COOLTRAINER_F2, OPP_LASS, 4
	object_event 58,  4, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE4_TM_WIND_SHEAR, TM_WIND_SHEAR
