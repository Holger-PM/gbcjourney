...
RockTunnel1F_Object:
	...
	def_warp_events
	warp_event 15,  1, LAST_MAP, 2
	warp_event 15,  0, LAST_MAP, 2
	warp_event 15, 33, LAST_MAP, 3
	warp_event 15, 35, LAST_MAP, 3
	warp_event 36,  2, ROCK_TUNNEL_B1F, 1
	warp_event  4,  2, ROCK_TUNNEL_B1F, 2
	warp_event 16, 10, ROCK_TUNNEL_B1F, 3
	...
	object_event 17, 14, SPRITE_HIKER, STAY, UP, TEXT_ROCKTUNNEL1F_HIKER3, OPP_HIKER, 14
	object_event 23,  8, SPRITE_SUPER_NERD, STAY, DOWN, TEXT_ROCKTUNNEL1F_SUPER_NERD, OPP_POKEMANIAC, 7
	object_event 37, 21, SPRITE_COOLTRAINER_F, STAY, LEFT, TEXT_ROCKTUNNEL1F_COOLTRAINER_F1, OPP_JR_TRAINER_F, 17
	object_event 22, 22, SPRITE_COOLTRAINER_F, STAY, DOWN, TEXT_ROCKTUNNEL1F_COOLTRAINER_F2, OPP_JR_TRAINER_F, 18
