...
Route3_Object:
	...
	object_event 30, 21, SPRITE_YOUNGSTER, STAY, UP, TEXT_ROUTE3_YOUNGSTER5, OPP_BUG_CATCHER, 6
	...
	object_event 20, 21, SPRITE_COOLTRAINER_M, STAY, RIGHT, TEXT_ROUTE3_COOLTRAINER_M1, OPP_COOLTRAINER_M, 6
