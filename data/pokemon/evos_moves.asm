...
;	db 35, COUNTER
	...
	db 38, SUBMISSION
	db 42, MEGA_PUNCH
	db 48, ROCK_SLIDE ; Is that a good idea ?
;	db 41, KARATE_CHOP
	db 0
...
; Learnset
	...
	db 10, DISABLE
	db 14, DOUBLESLAP
	db 18, REFLECT ; is that a good idea ?
	db 21, HEADBUTT
	db 28, BODY_SLAM
	db 30, RECOVER
	db 38, LOVELY_KISS,
...
; Learnset
	db 9, EMBER
	db 13, LEER ; To Replace
	db 17, RAGE
	db 19, FIRE_PUNCH
	db 23, BITE
	db 28, ROAR
	db 33, SLASH ; Nerfed
	db 36, WING_ATTACK ; Give another flying STAB
	db 42, FLAMETHROWER
	db 48, SLAM
	db 56, FIRE_SPIN
	db 0
