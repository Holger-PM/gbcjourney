...
;	db ICE,          FIRE,         SUPER_EFFECTIVE		; Gen 2 correction
...
;	db POISON,       BUG,          SUPER_EFFECTIVE		; Gen 2 correction
	...
	db BUG,          POISON,       NOT_VERY_EFFECTIVE	; Gen 2 correction
	...
	db GHOST,        PSYCHIC_TYPE, SUPER_EFFECTIVE		; Gen 2 correction
