...
.next
	...
	ld de, 1
	call IsInArray
;;;;;;;;;; Holger - Checking that the base power is not 0
...
INCLUDE "data/battle/physical_special_split.asm" ; Physical Special Split
...
.notMetronomeEffect
	...
	ld de, $1
	call IsInArray
;;;;;;;;;; Holger note - Checking that the base power is not 0 (enemy)
